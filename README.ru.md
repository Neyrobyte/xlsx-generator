  ...
  "sheets": [
    {
      ...
      "data": [
        ["Событие", "Дата", "Дней"],
        ["Начало проекта", "2023-01-10", 0],
        ["Первая веха", "2023-02-15", 36],
        ["Завершение", "2023-05-20", 130]
      ]
    }
  ]
}
...
Эта документация обеспечивает полное понимание как для пользователей, так и для разработчиков, что облегчит использование и дальнейшую поддержку программы.
